...
function changeColor(decibels) {
  if (decibels < 50) {
    document.getElementById("disciplineStatus").innerText =
      "Excellent silence is there";
    color = "green";
  } else if (decibels >= 50 && decibels < 70) {
    document.getElementById("disciplineStatus").innerText =
      "Good silence is there";

    color = "yellow";
  } else if (decibels >= 70 && decibels < 90) {
    document.getElementById("disciplineStatus").innerText =
      "I think disturbance is there";

    color = "orange";
  } else {
    document.getElementById("disciplineStatus").innerText =
      "change your Location. Here is lot of disturbance";
